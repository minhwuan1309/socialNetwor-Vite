...
const Register = () => {
  ...
  return (
    <div className="flex justify-center">
      <div
        className="flex flex-col justify-center items-center md:flex-row shadow-2xl
      rounded-xl max-w-7xl w-[90%] md:[50%] md:mt-[40px]"
      >
        <div className="w-full md:w-3/4">
          <div className="text-xl cursor-pointer flex flex-col justify-center items-center mt-5 md:mt-0 px-4">
          ...
          <form onSubmit={submitHandler}>
            <div className="flex flex-col justify-center items-center m-2 space-y-6 md:space-y-8">
              {filePrev && <img src={filePrev} alt="avatar" className="w-[200px] h-[200px] rounded-full"/>}
              <input
                type="file"
